                      ...
                      <Col xs={{ order: todo.isBookmark ? 1 : 2 }} sm={12} md={6} key={index}>
                        <Card className={todo.isBookmark ? 'mb-3 shadow-sm' : 'mb-3'} style={{ backgroundColor: todo.color }}>
                          ...
                          <Card.Body>
                            ...
                            <Button className="me-2" onClick={() => handleStarTodo(todo._id, todo.isBookmark)} variant={todo.isBookmark ? 'dark' : 'outline-dark'} size="sm"> <i className="bi bi-star-fill"></i> {todo.isBookmark ? 'Pinned' : 'Pin'}</Button>
